...
export function EditStudent() {
    ...
    async function handleUpdateStudent(e) {
        e.preventDefault();
        try {
            const res = await axios.put(`${url}/student/${id}`, {
                stuID,
                name,
                age,
                email,
        ...
        <div className="m-5 sm:m-8">
            <div>
                ...
                <span className="flex m-1 mb-5">
                    ...
                    <p className="text-xs sm:text-xs text-gray-500">&nbsp; Edit Student</p>
                </span>
            </div>
            <form method="get" className="rounded-lg mt-3 pl-15 pt-5 bg-gray-200/40 flex flex-col gap-5" onSubmit={(e) => handleUpdateStudent(e)}>
