...
export function AddCourse() {
    ...
    const handleAddCourse = async (e) =>{
        try{
            e.preventDefault();
            const res = await axios.post(`${url}/course`, {
                courseId,
                courseName,
                duration,
                fee,
        ...
        <div>
            <div className="m-5 sm:m-8">
                ...
                <span className="flex m-1 mb-5">
                    ...
                    <p className="text-xs sm:text-xs text-gray-500">&nbsp; Add Course</p>
                </span>
            </div>
            <form method="get" className="rounded-lg mt-3 mx-15 pl-15 pt-5 bg-gray-200/40 flex flex-col gap-5" onSubmit={(e) => handleAddCourse(e)}>
                ...
                <button className="p-2 bg-blue-600 rounded-lg text-white">Save Course</button>
                </span>
            </form>
        </div>
    </>
